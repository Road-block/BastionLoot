...
if not L then return end
  ...
  L["Name"] = "名字"
  L["Raid Only"] = "只顯示團隊"
  L["Filter EPGP Standings to current raid members."] = "只顯示在團隊裏的成員"
  -- bids
  ...
  L["Group EPGP Standings by class."] = "按職業分組"
  L["Export"] = "導出"
...
完成後列印結果.]]
  ...
  L["|cffFF3333|Hbepgpbid:1:$ML|h[Mainspec]|h|r"] = "|cffFF3333|Hbepgpbid:1:$ML|h[主天賦/需求]|h|r"
  L["|cff009900|Hbepgpbid:2:$ML|h[Offspec]|h|r"] = "|cff009900|Hbepgpbid:2:$ML|h[副天賦/貪婪]|h|r"
  L["|cffFF3333|Hbepgpbid:3:$ML|h[Mainspec]|h|r"] = "|cffFF3333|Hbepgpbid:3:$ML|h[主天賦/需求]|h|r"
  L["|cff009900|Hbepgpbid:4:$ML|h[Offspec]|h|r"] = "|cff009900|Hbepgpbid:4:$ML|h[副天賦/貪婪]|h|r"
  L["Bids"] = "競標"
  ...
  L["Whisper %s a + for %s (MS)"] = "私聊 %s + 為 %s (主天賦)"
  L["Whisper %s a - for %s (OS)"] = "私聊 %s - 為 %s (副天賦)"
  L["Whisper %s a + or - for %s (MS or OS)"] = "私聊 %s + 或 - 為 %s (主天賦或副天賦)"
  ...
  L["Join Standby Channel"] = "啟動待命成員" -- needs update
  L["Participate in Standby Raiders Channel.\n|cffff0000Requires Main Character Name to be set.|r"] = "參與在備用團隊列表.\n|cffff0000要求大號名字.|r" -- needs update
