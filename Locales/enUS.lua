...
You can also whisper |cffffd200!PR Name|r to any EPGP admin online to get back information in whisper.
  ...
  L["Rank Filters"] = true
  L["Alt Rank"] = true
  L["Rank containing Alts for selection"] = true
  L["Main Ranks"] = true
  L["Ranks containing Mains"] = true
  L["Add/Remove Alts"] = true
  L["Select a Main first, then Add or Remove Alts"] = true
  L["Add Alt"] = true
  L["Remove Alt"] = true
  L["Toggle Alts"] = true
  L["BastionLoot Allies"] = true
  L["Allies"] = true
  L["Ally"] = true
  L["Stand-in"] = true
  L["standin: "] = true
  L["Enable Allies"] = true
  L["Allow Allies to use Stand-in\'s EPGP."] = true
  L["Allowed Stand-in Rank"] = true
  L["Select Rank that can be used as a Stand-in for Allies"] = true
  L["Manage stand-ins"] = true
  L["Select a member to act \nas an epgp stand-in for an out of guild ally. \n|cffff0000Cannot be a guild main's Alt.|r"]   = true
  L["Stand-in (guild)"] = true
  L["Select stand-in for ally"] = true
  L["Add Allies"] = true
  L["Select a Stand-in first, then input the Ally name (exact) and Class"] = true
  L["Ally Class (off-guild)"] = true
  L["Ally Class"] = true
  L["Ally Name (off-guild)"] = true
  L["MUST be exact (capitalization, special chars)"] = true
  L["Remove Allies"] = true
  L["Removes in-guiid epgp stand-in for an Ally"] = true
  L["Remove Ally"] = true
  L["Remove linked Ally stand-in"] = true
  L["Toggle Allies"] = true
  L[", %s\'s Standin"] = true
  L["%s is %s and %s is an Ally with %s standin. Skipping %s."] = true
  L["Duplicate standin detected for ally %q: %s < %s"] = true
  L[", allies"] = true
  L["New Allies"] = true
  L["Manually modified %s\'s note. Previous ally info %s, %d:%d"] = true
  ...
  L["Change Raid Difficulty"] = true
  L["Send Request for Raid Difficulty change to Raid Leader"] = true
